 ...
 *  Global admins may request canonical generation from PrepShip; the portal
 *  never calculates or persists billing truth itself. */
export default function Billing() {
  ...
  const canUpdateBilling = Boolean(me.data?.isGlobal && me.data?.canViewFinancials);
    ...
    <div className="space-y-4">
      ...
      <GlassPanel className="space-y-3 p-4">
        ...
        <p className="text-[11px] text-ink-3">
          Billing truth is generated by PrepShip. Global admins can update the selected range here; all other users have read-only access.
        </p>
      </GlassPanel>
