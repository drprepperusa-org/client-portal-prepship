...
export function toCanonicalBillingEventRow(
  ...
  // The deployed producer now supplies identity for every event, including storage.
  // A positional substitute would reuse identities when sorting or changing pages.
